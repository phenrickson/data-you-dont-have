...
Side note: these estimates are not based on Virgil Carter's 1969 NFL Season, but my own expected points model trained on all college football plays from 2007-2019.
...
team_scores |>
  filter(season >= 2018) |>
  plot_team_score_by_week(team = 'Wisconsin', ranking = 25)
```
