...
team_scores |>
  team_scores_by_week(season = 2024, week = 20, team_info = team_info) |>
  team_scores_tbl() |>
  gt::cols_hide("diff") |>
  gt::cols_unhide("week") |>
  gt::opt_interactive(active = F) |>
  gtExtras::gt_theme_nytimes()
...
You then use these **measurements of team efficiency** to simulate the outcome of games.
